...
@SpringBootTest(classes = {ShopService.class, Authenticator.class,
        OrderFacade.class, ProductService.class, FacadeWatcher.class})
class ShopServiceTestSuite {
    ...
    void testShopServiceSubmitOrder() {
        ...
        if (orderId > 0) {
            ...
            if (shopService.removeItem(orderId, 100L)) {
                System.out.println("Item 100 was deleted from the order");
            } else {
            ...
            if (shopService.doPayment(orderId)) {
                System.out.println("Payment for the order was done");
            } else {
            ...
            if (shopService.verifyOrder(orderId)) {
                ...
                System.out.println("Order can not be submitted");
            }
    ...
    public void testShopFacade() {
        ...
        try {
            ...
            System.out.println("To be handled in real world");
        }
    }
